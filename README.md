...
- Scans public web sources for company descriptions, likely website, source pages, public business emails/phones, and named contacts when available.
...
- Ranks the best contact targets for each account, explains why each role matters, and gives source-backed public contacts plus search links to verify named people.
...
Public award data usually does not include verified direct emails or phone numbers. The app now performs a best-effort public web scan and records source URLs for any names, emails, and phone numbers it finds. It does not bypass logins or paywalls, and SDRs should verify each contact before outreach.
