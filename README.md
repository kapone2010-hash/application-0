...
- Scans public web sources for company descriptions, likely website, source pages, public business emails/phones, named contacts, call-intel signals, and public LinkedIn result signals when available.
...
Public award data usually does not include verified direct emails or phone numbers. The app now performs a best-effort public web scan and records source URLs for any names, emails, phone numbers, LinkedIn result signals, announcements, interviews, podcasts, and other call-intel triggers it finds. It does not bypass LinkedIn login, other logins, or paywalls, and SDRs should verify each contact before outreach.
